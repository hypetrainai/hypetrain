...
class _ModuleWrapper(ModuleType):
    ...
    def __init__(self, *args, **kwargs):
        ...
        parser.add_argument('--log_dir', type=str, default='trained_models/splitter_reduction1_128chan_16layer', help='where to save the models')
        ...
        parser.add_argument('--data_dir', type=str, default='data/musdb', help='the directory that contains train/test directories.')
        parser.add_argument('--module_name', type=str, default='splitter')
        parser.add_argument('--model_name', type=str, default='Generator')
        parser.add_argument('--lr', type=float, default=1e-4)
        parser.add_argument('--clip_grad_norm', type=float, default=-1)
        parser.add_argument('--batch_size', type=int, default=4)
        parser.add_argument('--train_seqlen', type=int, default=16000, help='sequence length during training')
