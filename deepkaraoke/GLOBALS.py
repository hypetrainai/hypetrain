...
class _ModuleWrapper(ModuleType):
    ...
    def __init__(self, *args, **kwargs):
        ...
        parser.add_argument('--checkpoint', type=str, default='', help='suffix for checkpoint file to restore from')
        #parser.add_argument('--data_dir', type=str, default='data/MIR-1K', help='the directory that contains train/test.pkl.gz')
        parser.add_argument('--data_dir', type=str, default='data/16k_LARGE_fixed', help='the directory that contains train/test.pkl.gz')
