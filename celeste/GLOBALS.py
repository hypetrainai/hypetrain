...
class _ModuleWrapper(ModuleType):
    ...
    def __init__(self, *args, **kwargs):
        ...
        parser.add_argument('--log_dir', type=str, default='trained_models/firstmodel_bellman_lastV_higherentropy_12lookahead', help='where to save the models')
        ...
        parser.add_argument('--bellman_lookahead_frames', type=int, default=12, help='number of frames to consider for bellman rollout')
